...
"""Gate: a `--self-test` holds rules, and no rule passes without reading anything.
    ...
    scripts/gates/wiring/selftest-honest.py [--check]
    scripts/gates/wiring/selftest-honest.py --self-test
...
BODIES = (
    ...
    "scripts",
    "scripts/gates/code",
    "scripts/gates/hookgates",
    "scripts/gates/repo",
    "scripts/gates/testpolicy",
    "scripts/gates/wiring",
    "scripts/gates/wrap",
    "scripts/mcp",
)
