...
"""Gate: a lane's answer to a real call changes only when somebody rewrites it.
    ...
    scripts/gates/hookgates/verdict-corpus.py [--check]
    scripts/gates/hookgates/verdict-corpus.py --harvest [TRANSCRIPT...]
    scripts/gates/hookgates/verdict-corpus.py --self-test
...
CORPUS = ROOT / "scripts" / "gates" / "hookgates" / "verdict-corpus.json"
