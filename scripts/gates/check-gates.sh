...
gates=(
    ...
    "shell-binds|python3 hooks/shell_binds.py --self-test"
    ...
    "hooks-wired|python3 scripts/gates/hooks-wired.py --check"
    "hooks-wired-self|python3 scripts/gates/hooks-wired.py --self-test"
    "wrap-scale|python3 scripts/gates/wrap-scale.py --check"
    "wrap-scale-self|python3 scripts/gates/wrap-scale.py --self-test"
    "wrap-runtime|python3 scripts/gates/wrap-runtime.py --check"
    "wrap-runtime-self|python3 scripts/gates/wrap-runtime.py --self-test"
    "kit-live|python3 scripts/gates/kit-live.py --check"
    "kit-live-self|python3 scripts/gates/kit-live.py --self-test"
    "kit-probe|python3 hooks/kit-probe.py --self-test"
    "hook-latency|python3 scripts/gates/hook-latency.py --check"
    ...
    "blind-no-shell|python3 scripts/gates/blind-no-shell.py --check"
    "blind-no-shell-self|python3 scripts/gates/blind-no-shell.py --self-test"
    "no-command-reads|python3 scripts/gates/no-command-reads.py --check"
    "no-command-reads-self|python3 scripts/gates/no-command-reads.py --self-test"
