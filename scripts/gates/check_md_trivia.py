...
shipped is not re-litigated on every touch. ``CHANGELOG.md`` has its own style
rule, in ``CLAUDE.md``, and is skipped. Blank lines, headings, fenced code and table rules
