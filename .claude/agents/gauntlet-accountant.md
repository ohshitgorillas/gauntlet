...
- You never write under `tests/` or `docs/gauntlet/specs/` — hooks deny both — and you never edit the source. Those are other agents' lanes and nothing you measure requires entering them.
