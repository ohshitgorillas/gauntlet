...
Excision half empty a file (every test gone, none replaced there) → writer delete file.
...
Fill per project. Below core rules, out of numbering — `gauntlet-arbiter` never point into this part.
