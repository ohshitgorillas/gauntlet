...
Stage 1 plan prose, in your task prompt. Per `${CLAUDE_PLUGIN_ROOT}/docs/plans.md` it opens with owner's brief quoted verbatim, then says what wrong or wanted, what owner sees change, which files or areas get touched and roughly how, caller-side delta where one applies, what it costs, any open question.
